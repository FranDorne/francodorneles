...
const Header = () => {
    ...
    return (
        <div>
            ...
            <p className="line-1 anim-typewriter">Bienvenidos a mi portafolio... </p>
            ...
            <img id="not-dark" onClick={scrollTo} alt="Contact Me" title="Contact Me" className="gtp" src="contactar.png"></img>
        </div>
    )
